...
// GLOBAL NAVIGATION TOP LEVEL SCHEMA
const navLinks = [
                            ...
                            {activeGuide === "BEDS" && (
                                <>
                                    <div className="flex flex-col space-y-3.5 pt-2">
                                        ...
                                        <Link href="/beds/toddler" onClick={closeAllGuides} className="text-xs tracking-wider text-neutral-500 hover:text-black transition-colors">Toddler Beds</Link>
                                        <Link href="/beds/twin" onClick={closeAllGuides} className="text-xs tracking-wider text-neutral-500 hover:text-black transition-colors">Kids and Teen Beds</Link>
                                        <Link href="/beds/bunk" onClick={closeAllGuides} className="text-xs tracking-wider text-neutral-500 hover:text-black transition-colors">Bunk & Loft Beds</Link>
                                        <Link href="/beds/junior" onClick={closeAllGuides} className="text-xs tracking-wider text-neutral-500 hover:text-black transition-colors">Junior Beds</Link>
                                        <Link href="/beds" onClick={closeAllGuides} className="text-xs tracking-widest text-black font-bold uppercase pt-4 border-b border-black w-max pb-0.5 hover:opacity-70 transition-opacity">Shop All Beds →</Link>
                                    </div>
                                    <Link href="/beds/toddler" onClick={closeAllGuides} className="group text-center block">
                                        <div className="relative aspect-[4/3] bg-neutral-50 mb-2 overflow-hidden border border-neutral-100">
                                            <Image src="https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=400&q=80" alt="Beds Directory" fill sizes="25vw" className="object-cover group-hover:scale-102 transition-transform duration-300" />
                                        </div>
                                        <span className="text-[10px] tracking-widest text-neutral-400 uppercase font-medium group-hover:text-black">Toddler Beds</span>
                                    </Link>
                                    <Link href="/beds/twin" onClick={closeAllGuides} className="group text-center block">
                                        <div className="relative aspect-[4/3] bg-neutral-50 mb-2 overflow-hidden border border-neutral-100">
                                            <Image src="https://images.unsplash.com/photo-1540518614846-7eded433c457?auto=format&fit=crop&w=400&q=80" alt="Twin Beds" fill sizes="25vw" className="object-cover group-hover:scale-102 transition-transform duration-300" />
                                        </div>
                                    ...
                                    <Link href="/beds/bunk" onClick={closeAllGuides} className="group text-center block">
                                        <div className="relative aspect-[4/3] bg-neutral-50 mb-2 overflow-hidden border border-neutral-100">
                                            <Image src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=400&q=80" alt="Bunk Beds" fill sizes="25vw" className="object-cover group-hover:scale-102 transition-transform duration-300" />
                                        </div>
                            ...
                            {activeGuide === "CRIBS" && (
                                <>
                                    ...
                                    <Link href="/cribs?filter=standard" onClick={closeAllGuides} className="group text-center block">
                                        <div className="relative aspect-[4/3] bg-neutral-50 mb-2 overflow-hidden border border-neutral-100">
                                            <Image src="https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&w=400&q=80" alt="Cribs Directory" fill sizes="25vw" className="object-cover group-hover:scale-102 transition-transform duration-300" />
                                        </div>
                                    ...
                                    <Link href="/cribs?filter=conversion-kits" onClick={closeAllGuides} className="group text-center block">
                                        <div className="relative aspect-[4/3] bg-neutral-50 mb-2 overflow-hidden border border-neutral-100">
                                            <Image src="https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?auto=format&fit=crop&w=400&q=80" alt="Conversion Kit Directory" fill sizes="25vw" className="object-cover group-hover:scale-102 transition-transform duration-300" />
                                        </div>
                                    ...
                                    <Link href="/cribs?filter=mattresses" onClick={closeAllGuides} className="group text-center block">
                                        <div className="relative aspect-[4/3] bg-neutral-50 mb-2 overflow-hidden border border-neutral-100">
                                            <Image src="https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?auto=format&fit=crop&w=400&q=80" alt="Mattress Directory" fill sizes="25vw" className="object-cover group-hover:scale-102 transition-transform duration-300" />
                                        </div>
                ...
                <div className="lg:hidden fixed inset-0 top-[81px] z-40 flex animate-fadeIn">
                    ...
                    <div className="relative w-[85%] max-w-[320px] bg-white h-full p-6 flex flex-col overflow-y-auto z-10 shadow-2xl animate-slideInLeft">
                        {activeGuide ? (
                            <div className="flex flex-col h-full animate-fadeIn">
                                ...
                                {activeGuide === "BEDS" && (
                                    <>
                                        ...
                                        <div className="flex gap-4 mb-8 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide">
                                            <Link href="/beds/toddler" onClick={() => { setIsOpen(false); closeAllGuides(); }} className="block flex-shrink-0 w-36 snap-start">
                                                <div className="relative aspect-[4/3] bg-neutral-50 mb-2 border border-neutral-100 rounded-lg overflow-hidden"><Image src="https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=400&q=80" alt="Toddler Beds" fill sizes="150px" className="object-cover" /></div>
                                                <p className="text-[10px] text-center tracking-widest text-neutral-500 font-semibold uppercase">Toddler Beds</p>
                                            </Link>
                                            <Link href="/beds/twin" onClick={() => { setIsOpen(false); closeAllGuides(); }} className="block flex-shrink-0 w-36 snap-start">
                                                <div className="relative aspect-[4/3] bg-neutral-50 mb-2 border border-neutral-100 rounded-lg overflow-hidden"><Image src="https://images.unsplash.com/photo-15440518614846-7eded433c457?auto=format&fit=crop&w=400&q=80" alt="Twin Beds" fill sizes="150px" className="object-cover" /></div>
                                                <p className="text-[10px] text-center tracking-widest text-neutral-500 font-semibold uppercase">Kids and Teen Beds</p>
                                            </Link>
                                            <Link href="/beds/bunk" onClick={() => { setIsOpen(false); closeAllGuides(); }} className="block flex-shrink-0 w-36 snap-start">
                                                <div className="relative aspect-[4/3] bg-neutral-50 mb-2 border border-neutral-100 rounded-lg overflow-hidden"><Image src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=400&q=80" alt="Bunk Beds" fill sizes="150px" className="object-cover" /></div>
                                ...
                                {activeGuide === "CRIBS" && (
                                    <>
                                        ...
                                        <div className="flex gap-4 mb-8 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide">
                                            <Link href="/cribs?filter=convertible" onClick={() => { setIsOpen(false); closeAllGuides(); }} className="block flex-shrink-0 w-36 snap-start">
                                            ...
                                            <Link href="/cribs?filter=conversion-kits" onClick={() => { setIsOpen(false); closeAllGuides(); }} className="block flex-shrink-0 w-36 snap-start">
                                            ...
                                            <Link href="/cribs?filter=mattresses" onClick={() => { setIsOpen(false); closeAllGuides(); }} className="block flex-shrink-0 w-36 snap-start">
                                ...
                                {activeGuide === "DRESSERS" && (
                                    <>
                                        ...
                                        <div className="flex gap-4 mb-8 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide">
                                            <Link href="/dressers-storage?filter=dressers" onClick={() => { setIsOpen(false); closeAllGuides(); }} className="block flex-shrink-0 w-36 snap-start">
                                            ...
                                            <Link href="/dressers-storage?filter=bookcases" onClick={() => { setIsOpen(false); closeAllGuides(); }} className="block flex-shrink-0 w-36 snap-start">
                                            ...
                                            <Link href="/dressers-storage?filter=toy-boxes" onClick={() => { setIsOpen(false); closeAllGuides(); }} className="block flex-shrink-0 w-36 snap-start">
                            ...
                            <nav className="flex flex-col space-y-4 pt-4 text-xs tracking-wider font-medium text-neutral-700">
                                {navLinks.map((link) => (
                                    <button
                                        key={link.label}
                                        onClick={() => {
                                            if (link.isGuideTrigger && link.guideKey) {
                                                setActiveGuide(link.guideKey);
                                            } else {
                                                setIsOpen(false);
                                                if (link.href.includes("#")) {
                                                    setTimeout(() => scrollToSection(link.href), 80);
                                        ...
                                        className="text-left py-2 border-b border-neutral-100 uppercase flex items-center justify-between"
                                    >
                                        <span>{link.label}</span>
                                        {link.isGuideTrigger && <span className="text-neutral-400">→</span>}
                                    </button>
                                ))}
                            </nav>
                        )}
